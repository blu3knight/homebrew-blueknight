cask 'synology-drive-client' do
  ...
  url "https://global.download.synology.com/download/Tools/SynologyDriveClient/#{version.major_minor_patch}/Mac/Installer/synology-drive-client-#{version.after_comma}.dmg"
